...
Inspect the V3 persistence types captured immediately before the V4 writer change. The system prompt head is a persisted `system/message` event, PTC dispatch events replace the V2 code-dispatch names, and request headers no longer carry `data.header.system`. This snapshot retains V3’s declared types, including same-version payload additions that no published tag captures.
...
The source is the tag `dsh-v0.1.6-alpha.1`, whose writer constant is 3 and whose tree this checkout’s ancestry merged; the [prerelease archive](../releases/README.md) captured tags only through `dsh-v0.1.5-rc.2`. This snapshot is the checkout’s complete V3 inventory immediately before the V4 writer change, so four payload roots retain later same-version additions that no tag captures: the `goal/change` snapshot members `maxGoalTokens` and `maxGoalWorkMs` with the `tokensAtCreate` and `workMsAtCreate` counters, and message-source `tokensUsed` and `workMsUsed` on `agent/inbox/spliced`, `session/title-llm-request`, and `user/message`.
...
- `SessionHeader.version` resolves to the literal 3; physical `JsonlHeaderLine.version` remains `number`. Logical and physical headers require `isSeeded` with no `seedLength`.
- The system prompt head is a persisted `system/message` event, and `request/header.data.header` declares no `system` member. `tool/ptc-dispatch` and `tool/ptc-dispatch-start` replace the V2 `code-dispatch` names, and the V2 preset id `code` yields `ptc` in headers and selections.
- `assistant/chunk` is absent. `assistant/message.data` and log-only `assistant/attempt.data` require an embedded `stream`.

The [V3 codec](../../../packages/session/session-format-v2-to-v3/src/codec.ts) owns one-event-per-row framing, hard structural admission, and recoverable canonical event validation, including source-event range decoding. The [V2-to-V3 specification](../../../packages/session/session-format-v2-to-v3/README.md#v2-to-v3-specification) owns system-head insertion, PTC and preset names, sequence-reference remapping, and canonical envelope conversion.
...
roots:
  ...
  "event:agent/inbox/spliced": 68d464aa2a05151ea659d382a7d62fa6b893231668ed95f9146fd9f39eda3328
  ...
  "event:goal/change": 91b1959f77647fbd930d89a8e01413a241d5f46ce5b4353ee2bb2407b6d1649f
  ...
  "event:session/title-llm-request": 813ba0eec41b0d095cf0e7457cc3137c2c98e4d015a0eb2b62543d0da5e9f718
  ...
  "event:user/message": 9754c81e96a39c602f3dd717e5bcbc01a5153a2f7dd39ebcd0df9d899fdbeaff
...
| `event:agent/inbox/spliced` | event | `68d464aa2a05151ea659d382a7d62fa6b893231668ed95f9146fd9f39eda3328` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:goal/change` | event | `91b1959f77647fbd930d89a8e01413a241d5f46ce5b4353ee2bb2407b6d1649f` | [`event:goal/change`](#persistence-type-eventgoalchange) |
...
| `event:session/title-llm-request` | event | `813ba0eec41b0d095cf0e7457cc3137c2c98e4d015a0eb2b62543d0da5e9f718` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:user/message` | event | `9754c81e96a39c602f3dd717e5bcbc01a5153a2f7dd39ebcd0df9d899fdbeaff` | [`event:user/message`](#persistence-type-eventusermessage) |
...
SHA-256: `68d464aa2a05151ea659d382a7d62fa6b893231668ed95f9146fd9f39eda3328`
...
SHA-256: `25aff16418d1562996c5b91a67fdd0116d00091d4edd98ed2af3bb9175eae78a`
...
SHA-256: `f2dd79f8ca6ded4c74ab5cb04d18f5dcd73713bf421e3f96e5107b8fc1d6a3fd`
...
SHA-256: `91b1959f77647fbd930d89a8e01413a241d5f46ce5b4353ee2bb2407b6d1649f`
...
SHA-256: `813ba0eec41b0d095cf0e7457cc3137c2c98e4d015a0eb2b62543d0da5e9f718`
...
SHA-256: `48c9ba6cf80f40a2d80492fb9a0e2f872d399d8495056edf2bafb78dfd4c6e4c`
...
SHA-256: `9754c81e96a39c602f3dd717e5bcbc01a5153a2f7dd39ebcd0df9d899fdbeaff`
...
SHA-256: `1f2cf1023e894c2f7590cb9e73e6310325ffbc50ca9c83d81aa0ef12e3b4f8d1`
...
SHA-256: `34b47faaa311eb116822beeb98c06fa7418eb724e047bf7d803ed6868c53e949`
...
SHA-256: `e3d44cc4ad1a1b9ebff376fefe2d94d4cbd651cc1abe1d63943d9932167cc17b`
...
| `tokensAtCreate` | optional | `number` |
| `updatedAt` | required | `number` |
| `version` | required | `1` |
| `workMsAtCreate` | optional | `number` |
...
SHA-256: `4405bf1d8728b04e2e1e55a54209b60675774a61f6cc84f361edcbbcb0d27910`
...
| `id` | required | `string` |
| `maxGoalRounds` | required | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
| `maxGoalTokens` | required | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
| `maxGoalWorkMs` | required | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
...
SHA-256: `9fd4c6144cae54279106c78925334cee9c6df03565028f345e070bcac163c20d`
...
SHA-256: `13d503f17714520aabf6fda980e2989daf9ec5492d2a12815da745a90615a740`
...
SHA-256: `3bc84d9b5fecb97ad0c63a372907a0812c6c725a41c588d5b6a12725368bb7c4`
...
SHA-256: `353026d47049505ebc264ba79fb46c036a04cc605295216f4ecbdc003ae59b26`
